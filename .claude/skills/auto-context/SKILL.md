...
### 7. Actualizar `CLAUDE.md` secciones de Arquitectura y Watch Out For si aplica

## Principio
La documentación debe ser suficiente para que alguien (o Claude en una sesión nueva) entienda el proyecto completo leyendo solo la carpeta `docs/`.
